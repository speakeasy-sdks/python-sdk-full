...
from ...models.shared import terminaldetails as shared_terminaldetails
from typing import Dict, List, Optional


@dataclasses.dataclass
class GetTerminalByMobileNumberRequest:
    terminal_phone_no: str = dataclasses.field(metadata={'path_param': { 'field_name': 'terminal_phone_no', 'style': 'simple', 'explode': False }})
