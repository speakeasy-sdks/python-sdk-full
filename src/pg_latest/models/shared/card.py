...
class Card:
    ...
    card_bank_name: Optional[CardBankName] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('card_bank_name'), 'exclude': lambda f: f is None }})
    r"""One of [\\"Kotak\\", \\"ICICI\\", \\"RBL\\", \\"BOB\\", \\"Standard Chartered\\"]. Card bank name, required for EMI payments. This is the bank user has selected for EMI"""
    ...
    channel: Optional[Channel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('channel'), 'exclude': lambda f: f is None }})
    r"""The channel for card payments can be \\"link\\" or \\"post\\". Post is used for seamless OTP payments where merchant captures OTP on their own page."""
