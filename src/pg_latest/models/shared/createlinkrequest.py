...
from .linkmetaentity import LinkMetaEntity
from .linknotifyentity import LinkNotifyEntity
...
class CreateLinkRequest:
    customer_details: LinkCustomerDetailsEntity = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customer_details') }})
    ...
    link_meta: Optional[LinkMetaEntity] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('link_meta'), 'exclude': lambda f: f is None }})
    ...
    link_notify: Optional[LinkNotifyEntity] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('link_notify'), 'exclude': lambda f: f is None }})
