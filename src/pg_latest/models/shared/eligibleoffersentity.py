...
class EligibleOffersEntity:
    ...
    entity_details: Optional[shared_offerentity.OfferEntity] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entity_details'), 'exclude': lambda f: f is None }})
