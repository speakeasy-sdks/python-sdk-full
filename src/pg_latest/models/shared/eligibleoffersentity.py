...
import dataclasses
from .offerentity import OfferEntity
...
class EligibleOffersEntity:
    ...
    entity_details: Optional[OfferEntity] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entity_details'), 'exclude': lambda f: f is None }})
