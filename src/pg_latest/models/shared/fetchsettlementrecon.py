...
class FetchSettlementReconData:
    ...
    r"""Specifies whether the dispute was closed in favor of the merchant or customer. Possible values - Merchant, Customer."""
    ...
    r"""Amount corresponding to the event. Example, refund amount, dispute amount, payment amount, etc."""
    ...
    r"""The event type can be PAYMENT, REFUND, REFUND_REVERSAL, DISPUTE, DISPUTE_REVERSAL, CHARGEBACK, CHARGEBACK_REVERSAL, OTHER_ADJUSTMENT."""
    ...
    r"""An unique ID associated with the refund."""
