...
class Reconciliation:
    ...
    def post_recon(self, request: operations.PostReconRequest) -> operations.PostReconResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "fetch_pg_recon_request", 'json')
        ...
        res = operations.PostReconResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_settlement_recon(self, request: operations.PostSettlementReconRequest) -> operations.PostSettlementReconResponse:
        ...
        res = operations.PostSettlementReconResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
