...
class Settlements:
    ...
    def getsettlements(self, request: operations.GetsettlementsRequest) -> operations.GetsettlementsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='Getsettlements', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetsettlementsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res, headers=None)
    ...
    def post_settlements(self, request: operations.PostSettlementsRequest) -> operations.PostSettlementsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='post_/settlements', oauth2_scopes=[], security_source=None)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        headers = { **utils.get_headers(request), **headers }
        req_content_type, data, form = utils.serialize_request_body(request, operations.PostSettlementsRequest, "fetch_settlement_recon_request", False, True, 'json')
        ...
        res = operations.PostSettlementsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res, headers=None)
